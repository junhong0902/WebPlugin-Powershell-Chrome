...
[System.Reflection.Assembly]::LoadFrom("C:\Program Files (x86)\CyberArk\Password Manager\bin\lib\WebDriver.dll" -f $PathToFolder)
...
$lib_home = 'C:\Program Files (x86)\CyberArk\Password Manager\bin\lib\modules\'
